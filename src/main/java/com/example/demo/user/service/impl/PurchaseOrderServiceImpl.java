...
import com.example.demo.user.mapper.PurchaseOrderMapper; // QUAN TRỌNG: inject Mapper
import com.example.demo.user.repository.EmployeeRepository;
import com.example.demo.user.repository.ProductVariantRepository;
import com.example.demo.user.repository.PurchaseOrderRepository;
import com.example.demo.user.repository.SupplierRepository;
